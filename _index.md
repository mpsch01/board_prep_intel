...
**Last Updated:** 2026-05-18 (BATON 071 — promoted 5 board_prep_intel-specific custom skills to project-level so they resolve as bare slash commands; no DB/PDF/schema changes (DB row counts unchanged))
...
```
board_prep_intel/
├── BATON_active_071_20260518_custom_skills_project_level.md  — active BATON
