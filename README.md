...
**Git:** `main` → `<TBD>` (PR #19 merge commit — will be filled in post-merge during hash-backfill) → `https://github.com/mpsch01/board_prep_intel` (private)
...
```json
{
  ...
  "git_hash": "d2dab28-PRE-HOUSEKEEPING",
  "git_branch": "claude/inspiring-cannon-e99bfb (last worktree session; merges to main as PR #19)",
