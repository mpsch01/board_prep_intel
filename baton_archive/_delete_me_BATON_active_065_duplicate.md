# BATON 065 — 2026-05-06 — Null Session / Deferred Flag Decisions
...
- **Citation string** = raw text in `question_ref_pairs.ref_raw` — known, but unresolvable
...
- ~973 PDFs on disk (not 1,958 — `citation_only=0` does not mean PDF exists)
- `xref` is complete and faithful from BATON 058; gap is upstream acquisition
