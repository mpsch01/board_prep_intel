...
| M3 Analyst | Active | 20 py + 2 js + 1 json config; ICD-10, pathways, score analysis, article_currency (Layer 2), longitudinal delta, concept fingerprint enrichment, db_connect utility, citation QC |
...
- **Deferred flags ACTIVE:** DEFERRED-AAFP-BODY-SYSTEM-AUDIT, DEFERRED-KNOWN-DRUGS-EXPANSION, DEFERRED-QID-XREF-LIBRARY-GAPS (NEW-249 unmatched citations; 2024: 20 QIDs; 2025: 33 QIDs missing)
...
| DEFERRED-AAFP-BODY-SYSTEM-AUDIT | ACTIVE | AAFP body_system fields may be mislabeled; needs sweep to verify alignment with blueprint |
...
- **New deferred flag (BATON 049):**
  - DEFERRED-PRACTICE-Q-COVERAGE â€” Practice question 0-question warnings detected for Foundations/Preventive/Cardiovascular/Respiratory/Sexual-Reproductive/Psychiatric/Behavioral body systems; indicates qid_art_xref tagging coverage gap in some blueprint cells
- **BATON 055 concept fingerprint overhaul (2026-04-13):**
  ...
  - M3 script count: 15 py â†’ 16 py (+test file)
