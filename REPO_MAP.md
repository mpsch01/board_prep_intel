...
**Last Updated:** 2026-05-19 (BATON 076 — Tier 2 walk-down + corpus-wide question-text and subscript-orphan cleanup. 8 atomic DB-write workflows applied (all backed up, all BATON 075 invariants preserved): A3 choices_empty re-extraction (42 QIDs — 27 OK 5-of-5 + 15 PARTIAL_4OF5 source-PDF defect missing choice E); A2 truncation no-op (23 heuristic false-positives); QID-2024-0067 enrichment backfill via Sonnet 4.6 (~$0.01); blueprint+body_system verified; 8th UMBRELLA review (+1 net is honest signal); question_text contamination cleanup (42 QIDs, removed embedded answer-choice blocks); 2 specific choice fixes (QID-2020-0162 "proficiency" + QID-2021-0017 "A1c"); corpus-wide wandering-subscript cleanup via fix_subscript_orphans.py (206 questions, 239 orphans removed, 176 medical-knowledge recoveries via 14 rules covering A1c/B12/FEV1/T4/H2-blocker/α1-/H2O/S3 gallop/HCO3/PaO2/PaCO2/Lp-PLA2/phospholipase A2). **Final fidelity metrics all 0** (was 47+117+42+42+41 across 5 categories). 5 new M2 scripts. 4 deferred flags CLOSED (QID-2024-0067-ENRICHMENT, LAYER-B-UMBRELLA-PROMOTION, A3-SOURCE-PDF-MISSING-E, SUBSCRIPT-ORPHAN-CORPUS); 2 NEW (LAYER-A2-HEURISTIC-TUNING, CORPUS-QC-LAYER-A7-A8). No PDF changes. Active BATON: `BATON_active_076_20260519_tier2_apply_and_corpus_cleanup.md`.)
...
├── BATON_active_076_*.md              Active session handoff — read first every session
