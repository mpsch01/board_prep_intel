...
containing `_index.md`, `BATON_active_*.md`, `CLAUDE.md`, and `README.json`.
...
4. `README.json` — human-readable entry point with current counts
...
**DB State:** [article count, question count, QID-article pairs — from BATON or README.json]
